...
const NOTIFICATION_DOCS = [
  {
    ...
    messages: [
      {
        label: 'للمتسابقين',
        title: '📝 سؤال جديد وصلك!',
        body: 'أيها المتسابق! سؤال اليوم [رقم اليوم] متاح الآن. أجب قبل انتهاء الوقت وحصّل نقاطك! 🏆',
      },
      {
        label: 'للضيوف',
        title: '📝 سؤال جديد وصلك!',
        body: 'يا ضيفنا! سؤال اليوم [رقم اليوم] وصل. شارك وتحدَّ نفسك! ✨',
      },
      {
        label: 'عام',
        title: '📝 سؤال جديد وصلك!',
        body: 'سؤال اليوم [رقم اليوم] متاح الآن. أجب قبل انتهاء الوقت!',
      },
    ],
    ...
    messages: [
      {
        label: 'إجابة صحيحة',
        title: '🎉 إجابة صحيحة!',
        body: 'أحسنت [أيها المتسابق/يا ضيفنا]! إجابتك على سؤال اليوم [رقم] صحيحة. حصلت على [النقاط] نقطة! 🏆',
      },
      {
        label: 'إجابة خاطئة',
        title: '📋 تم تصحيح إجابتك',
        body: '[أيها المتسابق/يا ضيفنا]، تم تصحيح إجابتك على سؤال اليوم [رقم]. تفقد ملاحظة المصحح في التطبيق.',
      },
    ],
