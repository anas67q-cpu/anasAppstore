...
export default function StreakCard({ streak = 0, onOpen }) {
        ...
        <div className="w-24 h-24 flex items-center justify-center">
          {isActive ? (
            ...
            <svg width="88" height="88" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M26 6C26 6 18 15 18 24C18 28.418 21.582 32 26 32C30.418 32 34 28.418 34 24C34 15 26 6 26 6Z" fill="hsl(var(--muted))" />
              <path d="M26 18C26 18 22 23 22 27C22 29.209 23.791 31 26 31C28.209 31 30 29.209 30 27C30 23 26 18 26 18Z" fill="hsl(var(--muted-foreground))" opacity="0.4" />
            </svg>
          )}
        </div>
      </div>
